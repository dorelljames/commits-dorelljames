  ...
  return (
    <>
      ...
      <h1 className="mt-14 font-display text-4xl/tight font-light text-white">
        {`<127.0.0.1 />`}
        <br />
        <span className="text-sky-300">the tech canopy</span>
      </h1>
      <p className="mt-4 text-sm/6 text-gray-300">
        In this digital garden, I (Dorell James) journals everything I do - from
        scratching my own itch, to coding and building stuff, to basically
        everything I care about. This is the best place to learn more about what
        I am up to recently.
      </p>
      <SignUpForm />
...
export function IntroFooter() {
  return (
    <p className="flex items-baseline gap-x-2 text-[0.8125rem]/6 text-gray-500">
      Brought to you by{' '}
      <IconLink href="https://twitter.com/dorelljames" icon={XIcon} compact>
        Dorell James
      </IconLink>
    </p>
  )
